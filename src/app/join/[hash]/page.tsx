...
export default function JoinEventPage() {
  ...
  return (
    ...
    >
      <div className="backdrop-blur-sm bg-black/30 rounded-lg p-4 sm:p-6 max-w-4xl mx-auto">
        ...
        {requiredItems.length > 0 && (
          <div className="mb-6">
            <h2 className="text-lg sm:text-xl font-semibold text-white mb-3 break-words">
            ...
            <div className="space-y-3">
              {requiredItems.map((item) => (
                <div
                  key={item.id}
                  className="bg-white/10 p-3 sm:p-4 rounded-lg flex items-center justify-between gap-3"
                >
                  <div className="flex-1 min-w-0">
          ...
          <div className="mb-6">
            ...
            <div className="space-y-3">
              {optionalItems.map((item) => (
                <div
                  key={item.id}
                  className={`bg-white/10 p-3 sm:p-4 rounded-lg cursor-pointer transition-colors ${
                ...
                >
                  <div className="flex items-center justify-between gap-3">
                    ...
                    <div className={`text-xl sm:text-2xl flex-shrink-0 ${selectedItems.includes(item.id) ? "text-amber-400" : "text-gray-400"}`}>
                      {selectedItems.includes(item.id) ? "✓" : "○"}
                    </div>
                  </div>
                </div>
        ...
        {optionalItems.length === 0 && requiredItems.length === 0 && (
          <div className="mb-6">
            <p className="text-gray-300 text-center py-8 break-words">
        ...
        {/* Resumo */}
        <div className="bg-white/10 p-3 sm:p-4 rounded-lg mb-6">
          <h3 className="text-white font-semibold mb-2 break-words">Resumo da sua participação:</h3>
